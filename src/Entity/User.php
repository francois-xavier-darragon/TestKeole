...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?float $espaceInterpupillaire = null;
    ...
    public function getEspaceInterpupillaire(): ?float
    {
        return $this->espaceInterpupillaire;
    }

    public function setEspaceInterpupillaire(?float $espaceInterpupillaire): static
    {
        $this->espaceInterpupillaire = $espaceInterpupillaire;
